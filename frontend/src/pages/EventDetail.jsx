          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-white border border-gray-100 rounded-2xl p-6 h-fit shadow-sm">
              ...
              <div className="space-y-3 mb-5">
                <div className="flex justify-between"><span className="text-gray-500">Event Fee</span><span className="font-bold text-gray-900">₹{Number(event.registrationAmount)}</span></div>
                ...
                <div className="flex justify-between"><span className="text-gray-500">Location</span><span className="font-semibold text-gray-900">{event.location}</span></div>
              </div>
