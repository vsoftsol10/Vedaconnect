        ...
        <main className="p-8">
          ...
          {loading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {hubs.map((hub) => (
                <div key={hub.id} className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 flex flex-col">
                  ...
                  <button
                    ...
                    className="mt-auto w-full flex items-center justify-center gap-2 border border-gray-200 hover:bg-green-600 hover:text-white hover:border-green-600 transition-all duration-300 font-medium py-2.5 rounded-xl text-gray-700"
                  >
                    View Hub →
                  </button>
                </div>
