        ...
        <OnboardingCard>
          ...
          <div className="flex items-center justify-between mt-9">
            ...
            <button
              ...
              className="group inline-flex items-center gap-2 bg-amber-400 hover:bg-green-600 disabled:bg-gray-200 disabled:text-gray-400 disabled:cursor-not-allowed disabled:shadow-none disabled:ring-0 text-gray-900 hover:text-white font-semibold px-6 py-3.5 rounded-xl transition-all duration-300 shadow-sm hover:shadow-lg hover:shadow-green-200 ring-2 ring-transparent hover:ring-green-100"
            >
              {isSubmitting ? (
                <>
